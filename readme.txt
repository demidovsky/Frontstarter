...
Файлы в /pages должны иметь такое же имя, как и страница, для которой они предназначены - они подключатся автоматически.

Обычно все дополнительные модули включаются в common.less/js (вручную), но потенциально их можно подключать и в /pages.

В каждом из .less подключается файл /default/mixins.less. Он предоставляет:
