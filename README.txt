...
Проблема: Необходимость задавать страницам индвидуальные классы для <body>
Решение:
    для Битрикс:
    в коде страницы: $APPLICATION->SetPageProperty("bodyClass", "имястраницы");
    в header.php: <body class="page-<? $APPLICATION->showProperty("bodyClass");?>">