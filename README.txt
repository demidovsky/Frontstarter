...
Весь CSS- и JS-код делится на 2 категории: общий для всего сайта, либо индивидуальный для одной страницы.
...
Реализация типовых элементов практически не различается между проектами. Поэтому такие реализации складируются в виде готовых сниппетов.
